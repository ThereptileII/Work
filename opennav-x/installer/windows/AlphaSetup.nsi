...
!include "x64.nsh"
Name "OpenNav X Alpha 1"
OutFile "${OUTPUT}"
RequestExecutionLevel user
SetCompressor /SOLID lzma
VIProductVersion "0.2.0.0"
VIAddVersionKey "ProductName" "OpenNav X Alpha 1"
VIAddVersionKey "FileDescription" "Version-gated OpenNav X Alpha setup"
VIAddVersionKey "FileVersion" "0.2.0-alpha1"
...
Var ActionControl
Var Result
!define MUI_WELCOMEPAGE_TEXT "OpenNav X Alpha 1 is for evaluation, not approved navigation.$\r$\n$\r$\nThis setup verifies the exact supported OpenCPN 5.12.4 executable, installs beside it for this user, and preserves its shared navigation profile. Close all OpenCPN modes first.$\r$\n$\r$\nThe original OpenCPN program remains unchanged. Back up your normal OpenCPN profile before testing Alpha."
...
Function .onInit
  ${IfNot} ${RunningX64}
    MessageBox MB_ICONSTOP "Alpha 1 is validated on Windows x64 with the supported x86 OpenCPN ABI."
    Abort
  ${EndIf}
...
FunctionEnd
Function SourcePage
  !insertmacro MUI_HEADER_TEXT "Verified OpenCPN installation" "Install, update or repair the side-by-side Alpha integration."
...
Function SourceLeave
  ...
  ${EndIf}
FunctionEnd
Section "OpenNav X Alpha integration"
